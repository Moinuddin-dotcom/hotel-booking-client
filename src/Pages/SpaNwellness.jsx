...
const SpaNwellness = () => {
    return (
        <div className='max-w-[90vw] mx-auto my-10'>
            <h1 className='text-center font-semibold text-5xl' data-aos="fade-up" data-aos-once="false">Spa & Wellness</h1>
            <h1 className='font-semibold text-xl underline underline-offset-2' data-aos="fade-up" data-aos-once="false">Spa & Wellness</h1>
            <div className='space-y-4 text-gray-500 mb-10' data-aos="fade-up" data-aos-once="false">
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5' data-aos="fade-up" data-aos-once="false">
