    ...
    return (
        <div>
            ...
            <div className='max-w-[90vw] mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center gap-4'>
                <div className="card bg-base-100 shadow-xl" data-aos="fade-right" data-aos-once="false">
                ...
                <div className="card bg-base-100 shadow-xl" data-aos="fade-bottom" data-aos-once="false">
                    <div className="card-body">
