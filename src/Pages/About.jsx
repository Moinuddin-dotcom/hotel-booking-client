...
const About = () => {
    ...
    return (
        <div className=' max-w-[90vw] mx-auto my-20 space-y-3'>
            <h1 className='font-semibold text-2xl lg:text-5xl text-center ' data-aos="fade-up" data-aos-once="false">About Us</h1>
            ...
            <p className='text-gray-500 dark:bg-gray-900 dark:text-white' data-aos="fade-up" data-aos-once="false"> The Peninsula Chittagong Limited is situated at the prestigious GEC circle of the Port City; the hotel provides superior services combining western sophistication and Chittagonian hospitality in a scenic and convenient location. Tourists can discover this unique retreat for business or pleasure just minutes from the commercial center surrounded by famous retail shops, restaurants and corporate offices.</p>
            <div className="divider"></div>
            <div className="collapse bg-base-200 dark:bg-gray-500/45 dark:text-white dark:border-white dark:border-2">
                <input type="radio" name="my-accordion-1" defaultChecked />
                <div className="collapse-title text-xl font-medium dark:border-white">Nature of Business</div>
